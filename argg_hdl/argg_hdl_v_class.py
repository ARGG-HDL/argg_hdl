...
class v_class_converter(hdl_converter_base):
    ...
    def get_packet_file_content(self, obj):
        ...
        obj.__hdl_converter__.parse_file(obj)
        
        
        ret = "-- XGEN: Autogenerated File\n\n"
        inc = obj.__hdl_converter__.includes(obj, None, obj)
        ret += make_unique_includes(inc,obj.__hdl_converter__.get_type_simple(obj)+"_pack")
        ret += "\n\n"
        p_header = obj.__hdl_converter__.getHeader(obj,None, None)
        if p_header.strip():
            ...
            ret += obj.__hdl_converter__.getBody(obj,None, None)
            ret += "end "+ PackageName +";\n\n"
    ...
    def getHeader(self,obj, name,parent):
        ...
        for t in ts:
            ret +=  obj.__hdl_converter__.getHeader_make_record(t["symbol"], name,parent,t["symbol"]._Inout ,t["symbol"].varSigConst)
            ret += "\n\n"
...
-- End Connecting
    ...
    def _vhdl__reasign(self, obj, rhs, astParser=None,context_str=None):
        ...
        elif rhs._Inout == InOut_t.output_t:
    ...
    def extract_conversion_types(self, obj, exclude_class_type=None,filter_inout=None):
        ...
        if obj.__v_classType__ ==  v_classType_t.transition_t:
            ...
            x = v_class(obj.__hdl_converter__.get_NameSlave2Master(obj), obj.varSigConst)
            ...
            x = v_class(obj.__hdl_converter__.get_NameMaster2Slave(obj), obj.varSigConst)
            x.__v_classType__ = v_classType_t.Record_t
            x.__vetoHDLConversion__  = True
            x._Inout=InOut_t.output_t
