...
type axiStream_slv32_slave is record 
  ...
  procedure get_value_00_rshift (self :  inout  axiStream_slv32_slave; rhs :  inout  optional_t);
...
procedure get_value_00_rshift (self :  inout  axiStream_slv32_slave; rhs :  inout  optional_t) is
   
  begin 
 reset_0(self => rhs);
  
    if (self.data_internal_isvalid2 = '1') then 
      set_value_00_lshift(self => rhs, rhs => self.data_internal2);
      self.data_internal_was_read2 := '1';
