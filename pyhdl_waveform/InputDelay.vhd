...
--------------------------pipe2_2_stream_delay_one-----------------
  signal pipe2_2_stream_delay_one_Axi_in_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_2_stream_delay_one_Axi_in_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_2_stream_delay_one_Axi_out_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_2_stream_delay_one_Axi_out_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_2_stream_delay_one_clk : std_logic := '0'; 
-------------------------- end pipe2_2_stream_delay_one-----------------
--------------------------pipe2_3_stream_delay_one-----------------
  signal pipe2_3_stream_delay_one_Axi_in_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_3_stream_delay_one_Axi_in_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_3_stream_delay_one_Axi_out_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_3_stream_delay_one_Axi_out_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_3_stream_delay_one_clk : std_logic := '0'; 
-------------------------- end pipe2_3_stream_delay_one-----------------
--------------------------pipe2_4_stream_delay_one-----------------
  signal pipe2_4_stream_delay_one_Axi_in_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_4_stream_delay_one_Axi_in_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_4_stream_delay_one_Axi_out_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_4_stream_delay_one_Axi_out_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_4_stream_delay_one_clk : std_logic := '0'; 
-------------------------- end pipe2_4_stream_delay_one-----------------
--------------------------pipe2_5_stream_delay_one-----------------
  signal pipe2_5_stream_delay_one_Axi_in_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_5_stream_delay_one_Axi_in_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_5_stream_delay_one_Axi_out_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_5_stream_delay_one_Axi_out_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_5_stream_delay_one_clk : std_logic := '0'; 
-------------------------- end pipe2_5_stream_delay_one-----------------
--------------------------pipe2_6_stream_delay_one-----------------
  signal pipe2_6_stream_delay_one_Axi_in_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_6_stream_delay_one_Axi_in_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_6_stream_delay_one_Axi_out_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_6_stream_delay_one_Axi_out_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_6_stream_delay_one_clk : std_logic := '0'; 
-------------------------- end pipe2_6_stream_delay_one-----------------
--------------------------pipe2_7_stream_delay_one-----------------
  signal pipe2_7_stream_delay_one_Axi_in_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_7_stream_delay_one_Axi_in_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_7_stream_delay_one_Axi_out_s2m : axiStream_slv32_s2m := axiStream_slv32_s2m_null;
  signal pipe2_7_stream_delay_one_Axi_out_m2s : axiStream_slv32_m2s := axiStream_slv32_m2s_null;
  signal pipe2_7_stream_delay_one_clk : std_logic := '0'; 
...
begin
  ...
  pipe2_2_stream_delay_one : entity work.stream_delay_one port map (
    ...
    clk => pipe2_2_stream_delay_one_clk
  );
  pipe2_3_stream_delay_one : entity work.stream_delay_one port map (
    ...
    clk => pipe2_3_stream_delay_one_clk
  );
  pipe2_4_stream_delay_one : entity work.stream_delay_one port map (
    ...
    clk => pipe2_4_stream_delay_one_clk
  );
  pipe2_5_stream_delay_one : entity work.stream_delay_one port map (
    ...
    clk => pipe2_5_stream_delay_one_clk
  );
  pipe2_6_stream_delay_one : entity work.stream_delay_one port map (
    ...
    clk => pipe2_6_stream_delay_one_clk
  );
